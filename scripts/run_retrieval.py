...
from fixit_ai.common import read_jsonl, write_json, write_jsonl
...
def main() -> None:
    ...
    if args.index:
        ...
        records = [
            {"packet_id": packet["packet_id"], "references": search_retrieval_index(packet, index, top_k=args.top_k)}
